...
class _RenameDeviceModalState extends State<RenameDeviceModal> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _deviceNameController.text = widget.oldName;
    if (widget.show) _controller.forward();
  }

  @override
  void didUpdateWidget(covariant RenameDeviceModal oldWidget) {
              ...
              child: Material(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Change Device Name for ${widget.oldName}',
                          style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: textColor)),
                      const SizedBox(height: 12),
                      TextField(
                        controller: _deviceNameController,
                        decoration: InputDecoration(
                          labelText: 'Enter your New Device Name',
