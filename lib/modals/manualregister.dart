...
class ManualRegisterModal extends StatefulWidget {
  final bool show;
  final VoidCallback onClose;
  final Function(String hostName, String ip, String deviceName) onConfirm;
  ...
  @override
  State<ManualRegisterModal> createState() => _ManualRegisterModalState();
}

class _ManualRegisterModalState extends State<ManualRegisterModal> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant ManualRegisterModal oldWidget) {
              ...
              child: Material(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Manually Register New Device',
                          style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: textColor)),
                      const SizedBox(height: 12),
                      Text(
                        'Enter the device name, host name and IPv4 in your Tailscale app:',
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'Enter device name (Can be anything.)',
                          filled: true,
                          ...
                          TextButton(
                            onPressed: () {
                              ...
                              if (host.isNotEmpty && ip.isNotEmpty) {
                                widget.onConfirm(ip, host, deviceName);
                                widget.onClose();
